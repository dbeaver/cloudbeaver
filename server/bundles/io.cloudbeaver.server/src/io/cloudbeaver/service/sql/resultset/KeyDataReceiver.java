...
public class KeyDataReceiver implements DBDDataReceiver {
    ...
    private final WebSQLDataStatementInfo statement;
    private final Set<Integer> updatedAttributes = new HashSet<>();

    public KeyDataReceiver(@NotNull DBDAttributeBinding[] attributes, @NotNull WebSQLDataStatementInfo statement) {
        ...
        for (int i = 0; i < keyAttributes.size(); i++) {
            ...
            if (!CommonUtils.isEmpty(keyAttribute.getName())) {
                ...
                if (binding != null) {
                    ...
                    statement.getResultRowValues()[index] = keyValue;
            ...
            for (int k = 0; k < attributes.length; k++) {
                ...
                if (column.isAutoGenerated() && updatedAttributes.add(k)) {
                    statement.getResultRowValues()[k] = keyValue;
                    break;
                }
            }
        }
