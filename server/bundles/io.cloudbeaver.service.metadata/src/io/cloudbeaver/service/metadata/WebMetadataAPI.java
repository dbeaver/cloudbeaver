 ...
 * Web service API
 */
public interface WebMetadataAPI extends DBWServiceAPI {

    @WebAction
    String getNodeDDL(WebSession webSession, WebNavigatorNodeInfo node, Map<String, Object> options) throws DBWebException;
