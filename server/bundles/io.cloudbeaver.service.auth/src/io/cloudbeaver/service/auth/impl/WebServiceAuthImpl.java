...
public class WebServiceAuthImpl implements DBWServiceAuth {
    ...
    @Override
    public WebAsyncAuthStatus asyncAuthLogin(
        @NotNull WebSession webSession,
        @NotNull String providerId,
        @Nullable String providerConfigurationId,
        boolean linkWithActiveUser,
        ...
        try {
            ...
            authTask.setJob(new WebAsyncAuthJob(providerId + " authentication job", smAuthInfo.getAuthAttemptId(), linkWithActiveUser));
    ...
    @Override
    public WebAsyncAuthTaskResult asyncAuthTaskResult(@NotNull WebSession webSession, @NotNull String taskId) throws DBWebException {
