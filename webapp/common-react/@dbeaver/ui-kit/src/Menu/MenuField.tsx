...
import { MenuProvider, Menu, MenuButton, MenuItem, MenuButtonArrow, useMenuStore, useStoreState } from './Menu.js';
    ...
    <div className={clsx('dbv-kit-menu-field', className)}>
      <MenuProvider store={store}>
        ...
        <MenuButton id={id} disabled={disabled}>
          {arrowIcon ?? <MenuButtonArrow className="dbv-kit-menu__arrow-icon" />}
        </MenuButton>
