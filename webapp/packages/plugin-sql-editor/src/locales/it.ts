export default [
  ...
  ['sql_execution_plan_view_table', 'Tabella'],
  ['sql_execution_plan_view_diagram', 'Diagramma'],
  ['sql_execution_plan_view_label', 'Vista del piano di esecuzione'],
  ['sql_execution_plan_diagram_zoom_in', 'Ingrandisci'],
  ['sql_execution_plan_diagram_zoom_out', 'Rimpicciolisci'],
  ['sql_execution_plan_diagram_fit_to_screen', 'Adatta allo schermo'],
  ['sql_execution_plan_diagram_reset_view', 'Reimposta vista'],
  ['sql_execution_plan_diagram_cost', 'Costo'],
  ['sql_execution_plan_diagram_rows', 'Righe'],
  ['sql_execution_plan_diagram_time', 'Tempo'],
  ['sql_execution_plan_diagram_node_collapse_hint', '{arg:type} — premi C per comprimere'],
  ['sql_execution_plan_diagram_node_expand_hint', '{arg:type} — premi C per espandere'],
  ...
  ['plugin_sql_editor_settings_highlight_white_space', 'Mettere in evidenza i caratteri di spazio bianco'],
  [
