export default [
  ...
  ['plugin_sql_editor_settings_auto_save', 'Автосохранение скрипт файлов'],
  ['plugin_sql_editor_settings_auto_save_description', 'Автоматически сохранять скрипт файлы'],
  [
    'plugin_sql_editor_settings_auto_save_description_git_integration',
    'Автоматически сохранять скрипт файлы. Эта настройка доступна только при отключенной интеграции с Git',
  ],
];
