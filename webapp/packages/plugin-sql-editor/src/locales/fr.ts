export default [
  ...
  ['sql_execution_plan_view_table', 'Tableau'],
  ['sql_execution_plan_view_diagram', 'Diagramme'],
  ['sql_execution_plan_view_label', "Vue du plan d'exécution"],
  ['sql_execution_plan_diagram_zoom_in', 'Zoom avant'],
  ['sql_execution_plan_diagram_zoom_out', 'Zoom arrière'],
  ['sql_execution_plan_diagram_fit_to_screen', "Ajuster à l'écran"],
  ['sql_execution_plan_diagram_reset_view', 'Réinitialiser la vue'],
  ['sql_execution_plan_diagram_cost', 'Coût'],
  ['sql_execution_plan_diagram_rows', 'Lignes'],
  ['sql_execution_plan_diagram_time', 'Temps'],
  ['sql_execution_plan_diagram_node_collapse_hint', '{arg:type} — appuyez sur C pour réduire'],
  ['sql_execution_plan_diagram_node_expand_hint', '{arg:type} — appuyez sur C pour développer'],
