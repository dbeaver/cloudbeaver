export default [
  ...
  ['administration_configuration_wizard_configuration_security_db_user_password_change_description', 'The database user password can be changed for an existing connection'],
