export default [
  ...
  ['administration_configuration_wizard_configuration_server_info_unsaved_message', 'Les paramètres peuvent être enregistrés sur la page de configuration du serveur'],
  ...
  ['administration_configuration_wizard_configuration_security_public_credentials_description', 'Permet d\'enregistrer les identifiants pour les utilisateurs non administrateurs'],
