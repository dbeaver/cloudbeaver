...
export const LicenseDrawerItem: React.FC<AdministrationItemDrawerProps> = function LicenseDrawerItem({
  ...
  return styled(useStyles(...style))(
    <Tab tabId={item.name} disabled={disabled} onOpen={() => onSelect(item.name)}>
      ...
      <TabTitle><Translate token='administration_configuration_wizard_license' /></TabTitle>
    </Tab>
  );
};
