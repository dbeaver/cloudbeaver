export default [
  ...
  ['administration_teams_tab_title', '角色'],
  ['administration_teams_tab_description', '角色管理'],
  ['administration_teams_team_creation', '创建角色'],
  ['administration_teams_team_id', '角色ID'],
  ['administration_teams_team_name', '角色名称'],
  ['administration_teams_team_description', '描述'],
  ['administration_teams_team_permissions', 'Permissions'],
  ['administration_teams_team_create_error', '创建角色出错'],
  ['administration_teams_team_save_error', '保存角色出错'],
  ['administration_teams_team_list_update_success', '角色列表已刷新'],
  ['administration_teams_team_list_update_fail', '角色列表刷新失败'],
  ['administration_teams_add_tooltip', '添加新角色'],
  ['administration_teams_refresh_tooltip', '刷新角色列表'],
  ['administration_teams_delete_tooltip', '删除选中的角色'],
  ['administration_teams_delete_confirmation', '您将删除这些角色：'],
