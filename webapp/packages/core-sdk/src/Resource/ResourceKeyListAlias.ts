...
export interface ResourceKeyListAliasFactory<
  TKey,
  TArgs extends any[],
  TOptions extends ResourceAliasOptions,
> extends ResourceAliasFactory<TKey, TOptions> {
  (...args: TArgs): ResourceKeyListAlias<TKey, TOptions>;
}

export function resourceKeyListAliasFactory<
  TKey = any,
  TArgs extends any[] = any[],
  TOptions extends ResourceAliasOptions = any,
>(
  id: string,
