...
import { MenuService, ActionService, DATA_CONTEXT_MENU, menuExtractItems, DATA_CONTEXT_LOADABLE_STATE } from '@cloudbeaver/core-view';
  ...
  private registerMenu() {
    this.menuService.addCreator({
      ...
      getItems: (context, items) => [
        ...items,
        ACTION_RESOURCE_MANAGER_SCRIPTS,
      ],
