...
This UI kit uses several CSS tokens to style menus (trigger button, popover, items).

## Common menu tokens

### Size and space

- `--dbv-kit-menu-button-padding-inline:` calc(var(--tw-spacing) \* 3) - Inline padding for the trigger button
- `--dbv-kit-menu-button-padding-block:` var(--tw-spacing) - Block padding for the trigger button
...
- `--dbv-kit-menu-background:` var(--dbv-kit-color-background) - Default background color for the trigger button
