...
export const manifest: PluginManifest = {
  ...
  providers: [
    ...
    () => import('./ConnectionInfoOriginResource').then(m => m.ConnectionInfoOriginResource),
    () => import('./ConnectionInfoOriginDetailsResource').then(m => m.ConnectionInfoOriginDetailsResource),
