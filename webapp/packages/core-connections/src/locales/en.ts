export default [
  ...
  ['connections_administration_tools_refresh_tooltip', 'Refresh connections'],
  ['connections_administration_tools_delete_tooltip', 'Delete selected connections'],
  ['connections_administration_tools_refresh_success', 'Connections were refreshed'],
  ['connections_administration_tools_refresh_fail', 'Connections refresh failed'],
