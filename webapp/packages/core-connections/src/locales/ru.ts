...
export default [
  ...
  ['connections_connection_authentication_save_credentials_for_user_tooltip', 'Эти учетные данные будут сохранены навсегда'],
  ...
  ['connections_connection_edit_save_credentials_shared_tooltip', 'Будет применено ко всем пользователям с доступом к этому подключению.'],
  ['connections_connection_share_credentials', 'Поделиться учетными данными с командой'],
  ['connections_connection_share_credentials_tooltip', 'Эти учетные данные не будут запрашиваться для участников команды к заполнению'],
