export default [
  ...
  ['connections_administration_tools_refresh_tooltip', 'Обновить подключения'],
  ['connections_administration_tools_delete_tooltip', 'Удалить выбранные подключения'],
  ['connections_administration_tools_refresh_success', 'Подключения обновлены'],
  ['connections_administration_tools_refresh_fail', 'Не удалось обновить подключения'],
