...
export default [
  ...
  ['connections_connection_authentication_save_credentials_for_user', 'Save credentials for current user'],
  ['connections_connection_authentication_save_credentials_for_user_tooltip', 'This credentials will be saved permanently'],
  ['connections_connection_authentication_save_credentials_for_session', 'Don’t ask again during the session'],
  ['connections_connection_authentication_save_credentials_for_session_tooltip', 'This credentials will be removed after logout'],
  ['connections_connection_edit_save_credentials_shared', 'Save credentials for all users with access'],
  ['connections_connection_edit_save_credentials_shared_tooltip', 'Will be applied to all users with access to this connection.'],
  ['connections_connection_share_credentials', 'Share credentials with teammates'],
  ['connections_connection_share_credentials_tooltip', 'The credentials will not be required for the teammates to fill in'],
