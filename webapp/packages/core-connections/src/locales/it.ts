...
export default [
  ...
  ['connections_connection_authentication_save_credentials_for_user_tooltip', 'These credentials will be saved permanently'],
  ...
  ['connections_connection_edit_save_credentials_shared_tooltip', 'It will be applied to all users with access to this connection.'],
