export default [
  ...
  ['plugin_resource_manager_no_resources_placeholder', 'No resources'],
  ...
  ['plugin_resource_manager_script_name_invalid_characters_message', 'Invalid character "{args.character}"'],
];