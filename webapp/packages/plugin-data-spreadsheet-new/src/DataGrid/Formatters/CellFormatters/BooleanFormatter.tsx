...
export const BooleanFormatter = observer<ICellFormatterProps>(function BooleanFormatter() {
  ...
  const holder = getComputed(() => formatter.get(cell));
  const textValue = getComputed(() => formatter.getText(holder));
  ...
  function toggleValue() {
    ...
    const nextValue = !resultColumn.required && holder.value === false ? null : !booleanValue;
  ...
  return (
    <GridBooleanFormatter
      ...
      value={holder.value as boolean | null}
      onClick={toggleValue}
