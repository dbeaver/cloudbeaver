export default [
  ...
  ['data_grid_table_editing_row_add_copy', 'Dupliquer la/les ligne(s)'],
  ['data_grid_table_editing_row_delete', 'Supprimer la/les ligne(s)'],
  ['data_grid_table_editing_row_revert', 'Revenir à la/aux valeur(s)'],
  ['data_grid_table_order', 'Tri'],
  ['plugin_data_spreadsheet_new_pin_column', 'Épingler la/les colonne(s)'],
  ['plugin_data_spreadsheet_new_unpin_column', 'Désépingler la/les colonne(s)'],
