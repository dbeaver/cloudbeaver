export default [
  ...
  ['data_grid_table_editing_row_add_copy', 'Duplica riga/righe'],
  ['data_grid_table_editing_row_delete', 'Elimina riga/righe'],
  ['data_grid_table_editing_row_revert', 'Ripristina valore/valori'],
  ['data_grid_table_order', 'Ordinamento'],
  ['plugin_data_spreadsheet_new_pin_column', 'Blocca colonna(e)'],
  ['plugin_data_spreadsheet_new_unpin_column', 'Sblocca colonna(e)'],
