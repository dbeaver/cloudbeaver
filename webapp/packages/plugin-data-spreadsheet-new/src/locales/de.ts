export default [
  ...
  ['data_grid_table_editing_row_add_copy', 'Zeile(n) duplizieren'],
  ['data_grid_table_editing_row_delete', 'Zeile(n) löschen'],
  ['data_grid_table_editing_row_revert', 'Wert(e) zurückkehren'],
  ['data_grid_table_order', 'Sortierung'],
  ['plugin_data_spreadsheet_new_pin_column', 'Spalte(n) anheften'],
  ['plugin_data_spreadsheet_new_unpin_column', 'Spalte(n) lösen'],
