export default [
  ...
  ['data_grid_table_editing_rows_add', 'Zeilen hinzufügen'],
  ['data_grid_table_editing_row_add_copy', 'Zeile duplizieren'],
  ['data_grid_table_editing_rows_add_copy', 'Zeilen duplizieren'],
  ['data_grid_table_editing_row_delete', 'Zeile löschen'],
  ['data_grid_table_editing_rows_delete', 'Zeilen löschen'],
  ...
  ['plugin_data_spreadsheet_new_unpin_columns', 'Spalten lösen'],
  ...
  ['data_grid_table_generate_sql_error_title', 'SQL konnte nicht generiert werden'],
  ...
  ['data_grid_table_generate_sql_ddl_no_support', 'Der Container unterstützt die Standard-DDL-Struktur nicht'],
];
