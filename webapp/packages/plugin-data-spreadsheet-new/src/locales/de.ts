export default [
  ...
  ['data_grid_table_generate_sql_dialog_title', 'Generiertes SQL'],
  ...
  ['data_grid_table_generate_sql_error_too_many_rows', 'Zu viele Zeilen ausgewählt. Maximal erlaubt: 1000'],
