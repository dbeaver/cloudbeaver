export default [
  ...
  ['data_grid_table_editing_row_add_copy', 'Duplicate row(s)'],
  ['data_grid_table_editing_row_delete', 'Delete row(s)'],
  ['data_grid_table_editing_row_revert', 'Revert value(s)'],
  ['data_grid_table_order', 'Sorting'],
  ['plugin_data_spreadsheet_new_pin_column', 'Pin Column(s)'],
  ['plugin_data_spreadsheet_new_unpin_column', 'Unpin Column(s)'],
