export default [
  ...
  ['data_grid_table_disable_sorting', 'Disabled'],
  ['data_grid_table_disable_all_sorting', 'Disable all'],
  ['data_grid_table_delete_filters_and_sorting', 'Reset filters / sorting'],
