export default [
  ...
  ['plugin_data_spreadsheet_new_pin_row_top', '固定行到顶部'],
  ['plugin_data_spreadsheet_new_pin_row_bottom', '固定行到底部'],
  ['plugin_data_spreadsheet_new_unpin_row', '取消固定行'],
  ['plugin_data_spreadsheet_new_unpin_all_rows', '取消固定所有行'],
