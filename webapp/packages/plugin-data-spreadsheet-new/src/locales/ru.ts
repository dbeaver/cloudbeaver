export default [
  ...
  ['data_grid_table_disable_sorting', 'Отключена'],
  ['data_grid_table_disable_all_sorting', 'Отменить сортировку всех колонок'],
  ['data_grid_table_delete_filters_and_sorting', 'Отменить фильтры / сортировки'],
