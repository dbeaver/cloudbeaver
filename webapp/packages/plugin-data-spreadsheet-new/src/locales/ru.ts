export default [
  ...
  ['plugin_data_spreadsheet_new_settings_description_label', 'Показать описание колонки в заголовке'],
  ['plugin_data_spreadsheet_new_settings_description_label_description', 'Показывает описание под названием колонки'],
];
