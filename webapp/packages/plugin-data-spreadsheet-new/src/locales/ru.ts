export default [
  ...
  ['plugin_data_spreadsheet_new_pin_row_top', 'Закрепить строку сверху'],
  ['plugin_data_spreadsheet_new_pin_row_bottom', 'Закрепить строку снизу'],
  ['plugin_data_spreadsheet_new_unpin_row', 'Открепить строку'],
  ['plugin_data_spreadsheet_new_unpin_all_rows', 'Открепить все строки'],
