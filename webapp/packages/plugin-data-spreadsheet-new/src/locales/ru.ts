export default [
  ...
  ['data_grid_table_editing_row_add_copy', 'Дублировать строку(и)'],
  ['data_grid_table_editing_row_delete', 'Удалить строку(и)'],
  ['data_grid_table_editing_row_revert', 'Отменить изменение(я)'],
  ['data_grid_table_order', 'Сортировка'],
  ['plugin_data_spreadsheet_new_pin_column', 'Закрепить колонку(и)'],
  ['plugin_data_spreadsheet_new_unpin_column', 'Открепить колонку(и)'],
