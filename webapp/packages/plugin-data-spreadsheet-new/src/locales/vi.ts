export default [
  ...
  ['plugin_data_spreadsheet_new_pin_row_top', 'Ghim hàng lên trên'],
  ['plugin_data_spreadsheet_new_pin_row_bottom', 'Ghim hàng xuống dưới'],
  ['plugin_data_spreadsheet_new_unpin_row', 'Bỏ ghim hàng'],
  ['plugin_data_spreadsheet_new_unpin_all_rows', 'Bỏ ghim tất cả hàng'],
