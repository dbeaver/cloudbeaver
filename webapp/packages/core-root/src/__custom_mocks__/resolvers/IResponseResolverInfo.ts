 ...
 */
import type { DefaultBodyType, GraphQLVariables, StrictRequest } from 'msw';
...
export type IResponseResolverInfo = ResponseResolverInfo<GraphQLResolverExtras<GraphQLVariables>, null>;
