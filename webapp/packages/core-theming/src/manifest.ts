...
export const coreThemingManifest: PluginManifest = {
  ...
  providers: [
    ...
    () => import('./ThemeSystemService.js').then(m => m.ThemeSystemService),
    () => import('./ThemeDarkService.js').then(m => m.ThemeDarkService),
    () => import('./ThemeLightService.js').then(m => m.ThemeLightService),
