export default [
  ['plugin_connection_view', 'Vista connessione'],
  ['plugin_connection_view_default', 'Vista connessione predefinita'],
  ['plugin_connection_view_reset', 'Ripristina predefinito'],
  ['plugin_connection_view_option_simple', 'Semplice'],
