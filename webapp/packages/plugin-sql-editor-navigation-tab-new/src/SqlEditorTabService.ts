...
import { SqlResultTabsService, ISqlEditorTabState, SqlEditorService, SqlDataSourceService, ESqlDataSourceFeatures, ISQLDatasourceUpdateData } from '@cloudbeaver/plugin-sql-editor-new';
