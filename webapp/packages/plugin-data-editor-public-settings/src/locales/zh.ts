export default [
  ['data_editor_public_settings_disable_edit_name', '禁用编辑'],
  ['data_editor_public_settings_disable_edit_description', '在数据查看器中为非管理员用户禁用数据编辑'],
  ['data_editor_public_settings_disable_data_copy_name', '禁用复制'],
  ['data_editor_public_settings_disable_data_copy_description', '在数据查看器中为非管理员用户禁用数据复制'],
