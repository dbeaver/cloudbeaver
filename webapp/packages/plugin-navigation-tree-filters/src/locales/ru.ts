export default [
  ...
  ['plugin_navigation_tree_filters_include', 'Включить'],
  ['plugin_navigation_tree_filters_exclude', 'Исключить'],
  ['plugin_navigation_tree_filters_submit_fail', 'Не удалось применить фильтры'],
  ['plugin_navigation_tree_filters_reset_fail', 'Не удалось сбросить фильтры'],
];
