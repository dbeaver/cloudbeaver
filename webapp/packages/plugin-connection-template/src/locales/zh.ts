export default [
  ...
  ['basicConnection_connectionDialog_listTitle', '数据库：'],
  ['basicConnection_connectionDialog_username', '用户库用户名：'],
  ['basicConnection_connectionDialog_usernamePlaceholder', '用户'],
  ['basicConnection_connectionDialog_password', '数据库用户密码：'],
