export default [
  ...
  ['administration_configuration_wizard_finish_success_message', 'Vous pouvez vous connecter en tant qu\'administrateur pour configurer des paramètres supplémentaires.'],
];
