...
const ServerNodeChangedDialog = importLazyComponent(() => import('./ServerNodeChangedDialog.js').then(m => m.ServerNodeChangedDialog));

@injectable(() => [RouterService, NotificationService, CommonDialogService, ServerNodeService])
export class ServerNodeChangedDialogBootstrap extends Bootstrap {
  constructor(
