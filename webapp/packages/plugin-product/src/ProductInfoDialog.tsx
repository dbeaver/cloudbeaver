              ...
              <>
                ...
                <FormFieldDescription className={s(styles, { formFieldDescription: true })} label={translate('app_product_info_contacts')}>
                  <div className={s(styles, { contactsInfo: true })}>
                    ...
                    <Link href={WebsiteLinksService.CONTACT_PAGE} target="_blank" rel="noopener noreferrer">
                      {' '}
                      Site{' '}
                    </Link>
                    or
                    <Link href={WebsiteLinksService.GITHUB_REPOSITORY_PAGE} target="_blank" rel="noopener noreferrer">
                      {' '}
                      Github
                    </Link>
                  </div>
