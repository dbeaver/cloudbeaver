 ...
 */
import type { ConnectionInfoOrigin, ConnectionInfoOriginDetails, ConnectionInfoResource, DatabaseConnection } from '@cloudbeaver/core-connections';
...
export interface IConnectionFormState {
  ...
  readonly originDetails: ConnectionInfoOriginDetails | undefined;
