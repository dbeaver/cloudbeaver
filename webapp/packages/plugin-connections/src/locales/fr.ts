export default [
  ...
  ['plugin_connections_connection_delete_error', 'Échec de la suppression de la connexion'],
  ['plugin_connections_connection_folder_create_error', 'Impossible de créer le dossier'],
  ['plugin_connections_connection_connect_error', 'Échec de la connexion'],
];
