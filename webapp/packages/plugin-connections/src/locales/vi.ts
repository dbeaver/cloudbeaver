export default [
  ...
  ['plugin_connections_connection_ssl_note', 'DBeaver does not verify SSL configuration and relies on the driver implementation. Please refer to the driver documentation for more information.'],
