...
export default [
  ...
  ['settings_connections_hide_connections_view_name', 'Скрыть подключения'],
  ['settings_connections_hide_connections_view_description', 'Подключения будут скрыты для всех пользователей, кроме администраторов'],
